        ...
        ${r.tracks
          .map(
            (t) => `<li>
              ...
              <span class="t-dots" aria-hidden="true"></span>
              <span class="t-len">${t.length}</span>
            </li>`,
          )
          .join('')}
      </ol>
      <div class="release__cta">
        ${linkBtn('Listen / Buy', r.bandcamp, 'solid')}
      </div>
    </div>
  </article>`
